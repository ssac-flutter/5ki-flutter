...
class _$_Rate with DiagnosticableTreeMixin implements _Rate {
  const _$_Rate({required this.code, required this.rate});
...
abstract class _Rate implements Rate {
  const factory _Rate({required final String code, required final num rate}) =
      _$_Rate;
