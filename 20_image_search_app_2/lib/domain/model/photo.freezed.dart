...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({num id, String webformatURL});
}
...
class _$_Photo with DiagnosticableTreeMixin implements _Photo {
  const _$_Photo({required this.id, required this.webformatURL});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Photo(id: $id, webformatURL: $webformatURL)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, webformatURL);
...
abstract class _Photo implements Photo {
  const factory _Photo(
      {required final num id, required final String webformatURL}) = _$_Photo;
